...
# python run_ho3d_anchor.py --anchor_folder anchor_results/dexycb_reference_view_ours --ycb_model_path ~/../../Experiments/simonep01/ho3d --img_to_3d

if __name__=='__main__':
    parser = argparse.ArgumentParser(description="Set experiment name and paths")
    parser.add_argument("--anchor_folder", type=str, default="anchor_results/dexycb_reference_view_ours", help="Path to the YCB-V model info JSON")
    parser.add_argument("--ycb_model_path", type=str, default="/home/../Experiments/simonep01/ho3d", help="Path to the YCB Video Models")
