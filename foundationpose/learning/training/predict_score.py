...
class ScorePredictor:
  def __init__(self, amp=True, ckpt_root_dir='/home/../Experiments/simonep01/checkpoints/FP_weights'):
    self.amp = amp
  ...
  def predict(self, rgb, depth, K, ob_in_cams, normal_map=None, get_vis=False, mesh=None, mesh_tensors=None, glctx=None, mesh_diameter=None):
    ...
    def find_best_among_pairs(pose_data:BatchPoseData):
      ...
      for b in range(0, pose_data.rgbAs.shape[0], bs): # Only one iteration
    ...
    # What's the point of this part? Always adding 100 to all scores?
    while 1:
